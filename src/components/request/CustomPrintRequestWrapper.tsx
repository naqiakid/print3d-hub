...
const CustomPrintRequestForm = dynamic(() => import('./CustomPrintRequestForm'), {
  ssr: false,
  loading: () => (
...
export default function CustomPrintRequestWrapper(props: Props) {
  return <CustomPrintRequestForm {...props} />
}
